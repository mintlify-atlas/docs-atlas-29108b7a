...
<CardGroup cols={2}>
  ...
  <Card title="Media Streaming" icon="play" href="/concepts/media-streaming">
    Learn about media streaming
  </Card>
  <Card title="Video API" icon="video" href="/api/wiki/videos">
    Work with video files
  </Card>
  <Card title="Audio API" icon="music" href="/api/wiki/audio">
